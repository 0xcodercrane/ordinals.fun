  ...
  return (
    <div className="h-[90px] flex items-center justify-between container mx-auto">
      ...
      <div className="flex gap-2">
        <a className="flex justify-center items-center p-2 rounded-full bg-main hover:bg-black/30 border border-transparent hover:border-br hover:shadow hover:shadow-black transition ease-in-out duration-300" href="http://">
