export default function Coincard({ openModal }) {
  return (
    <div className="p-1 mx-2 my-1 duration-300 border rounded-md bg-main text-white  hover:shadow-md hover:shadow-slate-800 hover:border-blue border-blue/20">
      <img
      ...
      />
      <div className="p-3">
        <p className="text-gray-200">545009.litemap</p>
