function orc20deploy(){
    ...
    _this.render = async function(){
        ...
        return '<p>Basic Options</p><div>\n' +
            ...
            '                    <input class="input" id="orc20-deploy-ticker" type="text" value=""' +
            '                           placeholder="e.g. orc"/>' +
            '                </div>' +
            '                    <label for="orc20-deploy-name">Name (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-name" type="text" value=""' +
            '                           placeholder="e.g. My Token"/>' +
            '                </div>' +
            '                </div>' +
            '                    <label for="orc20-deploy-id">ID (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-id" type="text" value=""' +
            '                           placeholder="default: 1"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-deploy-max">Supply (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-max" type="text" value="" placeholder="default: unlimited"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-deploy-lim">Limit per mint (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-lim" type="text" value="" placeholder="default: 1"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-deploy-dec">Decimals (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-dec" type="text" value="" placeholder="default: 18"/>' +
            '                </div>' +
            '<p>Advanced Options</p>' +
            '                <div>' +
            '                    <label for="orc20-deploy-ug">Upgradable (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-ug" type="text" value="" placeholder="default: true"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-deploy-wp">Migration (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-wp" type="text" value="" placeholder="default: false"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-deploy-v">Version (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-v" type="text" value="" placeholder="e.g. 1.0"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-deploy-msg">Message (optional)</label>' +
            '                    <input class="input" id="orc20-deploy-msg" type="text" value="" placeholder="any text"/>' +
            '                </div>' +
        '                <div>' +
        '                    <label for="orc20-deploy-key">Custom Key (optional)</label>' +
        '                    <input class="input" id="orc20-deploy-key" type="text" value="" placeholder="custom typed information"/>' +
        '                </div>';
    }
