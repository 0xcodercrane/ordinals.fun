function orc20mint(){
    ...
    _this.render = async function(){
        ...
        return '<div>\n' +
            ...
            '                    <input class="input" id="orc20-mint-ticker" type="text" value=""' +
            '                           placeholder="e.g. orc"/>' +
            '                </div>' +
            '                    <label for="orc20-mint-amt">Amount</label>' +
            '                    <input class="input" id="orc20-mint-amt" type="text" value=""' +
            '                           placeholder="e.g. 1000"/>' +
            '                </div>' +
            '                </div>' +
            '                    <label for="orc20-mint-id">ID (optional)</label>' +
            '                    <input class="input" id="orc20-mint-id" type="text" value=""' +
            '                           placeholder="default: 1"/>' +
            '                </div>' +
            '                <div>' +
            '                    <label for="orc20-mint-msg">Message (optional)</label>' +
            '                    <input class="input" id="orc20-mint-msg" type="text" value="" placeholder="any text"/>' +
            '                </div>' +
            '                </div>' +
            '                    <label for="orc20-mint-repeat">Repeat</label>' +
            '                    <input class="input" id="orc20-mint-repeat" type="text" value="1"' +
            '                           placeholder="default: 1"/>' +
            '                </div>';
    }
